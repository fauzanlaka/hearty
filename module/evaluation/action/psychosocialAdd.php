<?php
    ...
    if($lang_id=='th'){
        ...
        $form_data = array(
            ...
            'pes_tobacco' => addslashes($_POST['pes_tobacco']),
            'pes_tobacco_specify_en' => addslashes($_POST['pes_tobacco_specify_en']),
            'pes_alcohol' => addslashes($_POST['pes_alcohol']),
            'pes_alcohol_specify' => addslashes($_POST['pes_alcohol_specify']),
            'pes_drug' => addslashes($_POST['pes_drug']),
