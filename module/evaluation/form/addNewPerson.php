    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-title-w-btn">
                <h4 class="title"><?= language($lang_id, 'add new people') ?></h4>
                <p><a class="btn btn-primary icon-btn" href="?mod=biodata"><i class="fa fa-arrow-left"></i>back</a></p>
            </div>
            <hr>
            <div class="card-title-w-btn">
                <h4 class="title"><?= language($lang_id, 'background information') ?></h4>
                <p><a class="btn btn-default icon-btn" href="#"><i class="fa fa-file"></i><?= language($lang_id, 'part') ?> 1</a></p>
            </div>
            <div class="card-body">
                ...
                <button class="btn btn-primary icon-btn" type="button" onclick="addNewPerson('module/evaluation/action/addNewPerson.php', 'biodataForm')"><div id="processing"><i class="fa fa-fw fa-lg fa-check-circle"></i><?= button_link($lang_id, 'save') ?></div></button>
            </div>
        </div>
    </div>
</div>
